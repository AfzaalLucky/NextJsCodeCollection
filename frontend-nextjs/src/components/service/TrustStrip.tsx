const badges = [
  ...
  },
  {
    ...
    desc: 'No obligation',
    color: 'text-secondary-600 bg-amber-50',
  },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
          {badges.map((badge) => (
            <div key={badge.title} className="flex items-center gap-3 py-5 px-4 md:px-6">
              ...
              <div>
                <p className="font-semibold text-gray-900 text-sm leading-tight">{badge.title}</p>
